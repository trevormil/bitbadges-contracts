...
/// BitbadgesQuery is an override of QueryRequest::Custom to access Bitbadges-specific modules
...
impl Into<QueryRequest<BitbadgesQuery>> for BitbadgesQuery {
    fn into(self) -> QueryRequest<BitbadgesQuery> {
...
// This is a simpler way to making queries
impl Into<QueryRequest<BitbadgesQuery>> for SwapQuery {
    fn into(self) -> QueryRequest<BitbadgesQuery> {
        QueryRequest::Custom(BitbadgesQuery::Swap(self))
    }
}
...
// This is a simpler way to making queries
impl Into<QueryRequest<BitbadgesQuery>> for OracleQuery {
    fn into(self) -> QueryRequest<BitbadgesQuery> {
        QueryRequest::Custom(BitbadgesQuery::Oracle(self))
    }
}
...
impl Into<BitbadgesQuery> for TreasuryQuery {
    fn into(self) -> BitbadgesQuery {
        BitbadgesQuery::Treasury(self)
    }
}

// This is a simpler way to making queries
impl Into<QueryRequest<BitbadgesQuery>> for TreasuryQuery {
    fn into(self) -> QueryRequest<BitbadgesQuery> {
        QueryRequest::Custom(BitbadgesQuery::Treasury(self))
    }
}
